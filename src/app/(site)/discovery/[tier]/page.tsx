...
export default async function DiscoveryTierPage({ params, searchParams }: PageProps) {
  ...
  if (!email) {
    // If no email, they probably skipped intake. Redirect back.
    redirect(`/services/${tier}`);
  }
  ...
  return (
    <main className="min-h-screen pt-32 pb-20 px-4 bg-primary">
      <div className="max-w-4xl mx-auto">
        <div className="mb-12 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-secondary/10 border border-secondary/20 rounded-full text-secondary text-xs font-bold uppercase tracking-widest mb-4">
