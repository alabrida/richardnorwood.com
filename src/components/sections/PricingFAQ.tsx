...
const faqs = [
  { q: "What's the difference between Build and Command?", a: "Build installs the operating layer — visibility, automation, and cross-team alignment using the tools you already have. Command strengthens governance, simplifies the stack, and transitions the system so your team runs it independently." },
  { q: "Can I cancel at any time?", a: "Yes. Engagements are month-to-month after the initial commitment period is met." },
  { q: "Do I get access to a client portal?", a: "Yes. All active clients receive a dedicated portal with project tracking, asset delivery, and direct communication." }
]
